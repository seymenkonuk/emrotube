        ...
        return [
            ...
            "video_file" => [
                "name" => Validator::create()
                    ...
                    ->min(ValidationConfig::FILE_NAME_MIN_LEN)
                    ->max(ValidationConfig::FILE_NAME_MAX_LEN)
                    ->insertRegexRule(ValidationConfig::VIDEO_FILE_NAME_REGEX_ERROR, ValidationConfig::VIDEO_FILE_NAME_REGEX_RULE)
                    ->require(),
                "type" => Validator::create()
                    ->str()
                    ->insertAllowValues(ValidationConfig::ALLOW_VIDEO_FILES)
                    ->require(),
                "tmp_name" => Validator::create()
                    ->str()
                    ->require(),
                ...
                "size" => Validator::create()
                    ->int()
                    ->min(ValidationConfig::MIN_VIDEO_FILE_SIZE)
                    ->max(ValidationConfig::MAX_VIDEO_FILE_SIZE)
                    ->require(),
                "full_path" => Validator::create()
                    ->str()
                    ->optional(),
