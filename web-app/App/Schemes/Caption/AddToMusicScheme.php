        ...
        return [
            "caption_file" => [
                "name" => Validator::create()
                    ...
                    ->insertRegexRule(ValidationConfig::FILE_NAME_REGEX_ERROR, ValidationConfig::FILE_NAME_REGEX_RULE)
                    ->require(),
                "type" => Validator::create()
                    ->str()
                    ->insertAllowValues(ValidationConfig::ALLOW_CAPTION_FILES)
                    ->require(),
