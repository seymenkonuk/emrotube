<?php
// ============================================================================
// File:    VideoCategoryTableSeeder.php
...
class VideoCategoryTableSeeder extends Repository
{
    public function Up()
    {
        ...
        $lists = [];
        $category_count = CategoryTableSeeder::category_count;
        ...
        foreach ($dates as $i => $date) {
            $this->pdo
                ->prepare("INSERT INTO video_category (category_id, video_id, created_at) VALUES (:category_id, :video_id, :created_at)")
                ->execute([
                    ":category_id" => $lists[$i][0],
                    ":video_id" => $lists[$i][1],
                    ":created_at" => $date,
                ]);
        }
