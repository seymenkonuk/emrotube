...
class HistoryTableSeeder extends Repository
{
    public function Up()
    {
        ...
        foreach ($dates as $i => $date) {
            $this->pdo
                ->prepare("INSERT INTO history (channel_id, video_id, created_at) VALUES (:channel_id, :video_id, :created_at)")
                ->execute([
