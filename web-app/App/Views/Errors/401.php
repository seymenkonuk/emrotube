...
$title = $title ?? "Kimlik Doğrulama Gerekli";
$message = $message ?? "Bu işlemi gerçekleştirmek için oturum açmalısınız.";
$auth = $auth ?? null;
?>
...
<div class="flex flex-1 items-center justify-center">
    <div class="text-center">
        <h1 class="text-7xl sm:text-9xl font-extrabold text-gray-800">401</h1>
