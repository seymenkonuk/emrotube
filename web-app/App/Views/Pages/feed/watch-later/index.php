...
/** @var WatchLaterHeaderDTO $header */
...
<?= $this->layout("Layouts/MainLayout", [
    ...
    "activeNav" => "/feed/watch-later",
]) ?>

<!-- START CONTENT SECTION -->
<section class="grid grid-cols-1 gap-6">
    <?= $this->insert("Components/WatchLater/WatchLaterHeader", [
        "header" => $header,
    ]); ?>
</section>
...
<?php else: ?>
    <p class="text-gray-500 mb-6">Daha sonra izlemek için içerik eklemediniz</p>
<?php endif ?>
